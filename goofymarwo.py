...
# pygame setup
    ...
    bg = pygame.transform.scale(bg, (1193, 498))
    ...
    bottle_pos = pygame.Vector2(400, 160)
    ...
    while running:
        ...
        tap_rect = screen.blit(tap1, (525,50))
        finish = my_font.render("Submit", True, (0,0,0), (255,255,255))
        ...
        if mouse[0] == True and allow:
            ...
            if tap_rect.collidepoint(pos):
                screen.blit((brown_drop), (590,137))
                if not total_area > 105000:
                    total_area += rate*dt

        

        pygame.draw.rect(screen, (150, 75, 0), (545, 475-total_area/590, 115, total_area/590))

        print(total_area)
        
        fin_rect = screen.blit(finish, (150,100))
